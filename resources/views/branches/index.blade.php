...
<div class="container">
    ...
    {{-- Create Branch --}}
    <div class="mb-8">
        <button onclick="document.getElementById('create-branch-form').style.display='block'"class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Create Branch</button>
